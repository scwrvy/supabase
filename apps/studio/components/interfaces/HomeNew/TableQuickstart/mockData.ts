...
export const SOCIAL_MEDIA_TABLES: TableSuggestion[] = [
  {
    ...
    fields: [
      ...
      { name: 'follower_count', type: 'integer', nullable: false, default: 0 },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'share_count', type: 'integer', nullable: false, default: 0 },
      { name: 'created_at', type: 'timestamp', nullable: false },
